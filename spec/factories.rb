FactoryGirl.define do
  factory :account, class: ORMivoreApp::AccountStorageArAdapter::AccountRecord do |account|
  ...
  factory :shipping_address, class: ORMivoreApp::AddressStorageArAdapter::AddressRecord do
